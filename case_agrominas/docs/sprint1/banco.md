...
### 1.4.1 Usuários Administrativos (`usuarios_admin`)
...
### 1.4.3 Insumos Regenerativos (`insumos_regenerativos`)
...
### 1.4.5 Relação Artigos-Categorias (`artigos_categorias`)
...
### 1.4.6 Relação Artigos-Insumos (`artigos_insumos`)
...
### 1.4.7 Metadados dos Artigos (`metadados_artigos`)
...
## 1.6 Integridade e Consistência
...
## 1.7 Considerações de Projeto

### 1.7.1 Separação de responsabilidades
...
### 1.7.2 Preparação para integração com IA
